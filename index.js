...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=554792091566:+55 4799209-1566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD DO CAUSS BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Proprietário? Este é um recurso especial para o Causs ❌',
					ownerB: '[❗] Proprietário? Este é um recurso especial para o Causs ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Causs. Registre-se para fazer amizade com o Causs Bot por meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar Causs|17\n\n──「 CAUSS BOT 」──`,
			...
			const ownerNumber = ["5547992091566@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5547992091566@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5547992091566@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5547992091566@s.whatsapp.net"]//ubah nomor lo
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'dono':
					memeindodododododododododododododododo = awat kagApi.memeindododododododododododododododododo()
					bufferer = awat getbufferer(`https://i.pinimg.com/originals/81/c8/6e/81c86ede839f83f640bd3e5c956e22ce.png`)
					dark.sendMess(from, bufferer, image, {quoted: mek, caption: '*CRIADOR:* CAUSS\n*YOUTUBE:*https://www.youtube.com/c/caussZ\n*WPP:* wa.me/+554792091566\n*INSTA:* @animexx_png\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
			...
			reply(mess.wait)
                ...
                case 'marcar2':
                 ...
                 case 'marcar3':
					...
					break
				case 'limpar':
					if (!isOwner) return reply('Quem é Você?, Você não é o Causs')
					...
					break
				case 'bc':
					if (!isOwner) return reply('Causs? Você não é o Causs')
